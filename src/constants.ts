...
export default class Constants {
    ...
    static readonly tips = ([
        ...
        "想做出闪烁故障的效果？让透明度事件在-1和255之间反复横跳就可以啦~",
        "利用垂直判定可以写出很酷炫的谱面！",
        ...
        "引导就是谱面解法的提示，能够减少或避免初见杀，写一些奇怪配置时要记得做好引导哦",
        ...
        "本软件完全免费，请勿用于商业用途！",
        "没灵感写不下去了？那就先休息一会儿~",
        "有些音乐就是只适合聆听，不适合写谱的，如果你写不下去了有可能不是你的问题",
        "不必追求过于花的表演，一些很简单的表演可能也能够表达得很好",
        "除了判定线表演，不如再加一些音符表演吧！",
